    ...
    $(document).ready(function (){
        $.ajax({
            ...
            <div class="input-group mb-3">
                ...
                <div class="col-sm-5">
                    <input class="form-control" type="number" id="productPrice" name="productPrice" placeholder="${product.productPrice}" min="1000" max="1000000" value="${product.productPrice}">
                </div>
            </div>
            <div class="input-group mb-3">
                <label class="col-sm-5 col-form-label" style="color:#FEA116">Stock</label>
                <div class="col-sm-5">
                    <input type="number" min="1" max="100" name="productStock" id="productStock" class="form-control" value="${product.productStock}">
                </div>
            </div>
